...
//         Created:  Thu, 11 Feb 2016 18:54:21 GMT
//
//
...

{
   ...
   //^initializing histogram. First invoking the TFileService, and then defining a TH1D.
}
...
//LogInfo("Demo") << "number of tracks "<<tracks->size();
  ...
  //demohisto->Fill(tracks->size()); //filling the histogram we made
